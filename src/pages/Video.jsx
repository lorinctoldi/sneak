...
import { Container, Upper, Left, LeftInner, Range, Audio, Player, Progress, ProgressInner, VideoContainer, PauseVideo, Content, Actions, Info, Tag, Sub, Scroll, ProductContainer, Swipe, Product, GenderTag, ProductImage, ProductInfo, CardContainer } from './style/video.config'
